...
pip install pandas datasets scikit-learn trl transformers sacrebleu rouge-score unsloth jiwer && \
...
python train_deepseek_gloss2text.py --train_dir "$TRAIN_DIR" --num_epochs "$NUM_EPOCHS"
